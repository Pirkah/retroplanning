      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-lg font-bold text-slate-900 tracking-tight flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-slate-400">Cliquez pour accéder</span>
            </h2>
            <p className="text-xs text-slate-500">Choisissez l'espace sur lequel vous souhaitez collaborer aujourd'hui</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div
            ...
            className="group relative bg-white rounded-2xl border border-slate-200/90 hover:border-blue-400 p-5 shadow-xs hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center group-hover:scale-105 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-xs">
              ...
              <div className="pt-2 flex items-center gap-2 text-xs font-medium text-slate-600">
          ...
          <div
            ...
            className="group relative bg-white rounded-2xl border border-slate-200/90 hover:border-indigo-400 p-5 shadow-xs hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
          ...
          <div
            ...
            className="group relative bg-white rounded-2xl border border-slate-200/90 hover:border-amber-400 p-5 shadow-xs hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center group-hover:scale-105 group-hover:bg-amber-500 group-hover:text-white transition-all shadow-xs">
                  <Lightbulb size={24} />
                </div>
                <span className="px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-amber-100 text-amber-900">
                  Brainstorming
                </span>
              </div>
          ...
          <div
            ...
            className="group relative bg-white rounded-2xl border border-slate-200/90 hover:border-emerald-400 p-5 shadow-xs hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
          ...
          <div
            ...
            className="group relative bg-white rounded-2xl border border-slate-200/90 hover:border-purple-400 p-5 shadow-xs hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center group-hover:scale-105 group-hover:bg-purple-600 group-hover:text-white transition-all shadow-xs">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-purple-600 group-hover:translate-x-1 transition-transform">
          ...
          <div
            ...
            className="group relative bg-white rounded-2xl border border-slate-200/90 hover:border-slate-400 p-5 shadow-xs hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-xl bg-slate-100 text-slate-700 flex items-center justify-center group-hover:scale-105 group-hover:bg-slate-800 group-hover:text-white transition-all shadow-xs">
                  <ListOrdered size={24} />
                </div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-slate-700 group-hover:translate-x-1 transition-transform">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {events.map((evt, idx) => (
              <div
                ...
                className="p-3.5 rounded-xl border border-slate-200/80 hover:border-blue-400 hover:bg-blue-50/40 cursor-pointer transition group"
              >
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-md bg-slate-100 text-slate-700 group-hover:bg-blue-100 group-hover:text-blue-800 transition-colors">
                    Événement #{idx + 1}
                  </span>
                  <span className="text-xs font-bold text-indigo-600">{evt.date}</span>
                </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-slate-900">Équipe Run & Fun</h3>
            </div>
            <span className="text-[11px] font-semibold text-slate-400">{members.length} membres</span>
          </div>
          ...
          <div className="space-y-2.5">
            {members.map((member) => (
              <div
                key={member.id}
                className="p-2.5 rounded-xl border border-slate-100 hover:bg-slate-50/80 transition flex items-center gap-3"
              >
                <div
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-slate-900">Derniers échanges de l'équipe</h3>
            </div>
            <button
              onClick={() => setViewMode('messages')}
          ...
          <div className="space-y-2">
            {latestMessages.map((msg) => (
              <div
                ...
                className="p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100/80 cursor-pointer transition flex items-start gap-2.5"
              >
                <div
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between gap-1">
                    <span className="text-xs font-bold text-slate-800 truncate">{msg.authorName}</span>
                    <span className="text-[10px] text-slate-400">
                      {new Date(msg.timestamp).toLocaleDateString('fr-FR', { day: 'numeric', month: 'short' })}
                    </span>
                  </div>
                  <p className="text-xs text-slate-600 line-clamp-1 mt-0.5">{msg.content}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-slate-900">Idées les plus plébiscitées</h3>
            </div>
            <button
              onClick={() => setViewMode('ideas')}
          ...
          <div className="space-y-2">
            {topIdeas.map((idea) => (
              <div
                key={idea.id}
                onClick={() => setViewMode('ideas')}
                className="p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100/80 cursor-pointer transition flex items-start justify-between gap-3"
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-800 truncate">{idea.title}</span>
                  </div>
                  <p className="text-xs text-slate-500 line-clamp-1 mt-0.5">{idea.content}</p>
                </div>

                <div className="flex items-center gap-1 text-xs font-bold text-rose-500 shrink-0 bg-rose-50 px-2 py-1 rounded-lg">
