...
export const DEFAULT_IDEAS: IdeaItem[] = [
  {
    ...
    likes: 5,
    likedBy: ['Vianney Urbanick', 'Julien Nicolle', 'Mathias Samson', 'Sina Abdoul Bastoi', 'Théo'],
  ...
  },
  {
    ...
    likes: 4,
    likedBy: ['Julien Nicolle', 'Mathias Samson', 'Sina Abdoul Bastoi', 'Théo'],
  ...
  },
  {
    ...
    likes: 3,
    likedBy: ['Vianney Urbanick', 'Sina Abdoul Bastoi', 'Julien Nicolle'],
  ...
  },
  {
    ...
    likes: 5,
    likedBy: ['Mathias Samson', 'Vianney Urbanick', 'Julien Nicolle', 'Théo', 'Sina Abdoul Bastoi'],
  ...
  },
  {
    ...
    likes: 4,
    likedBy: ['Sina Abdoul Bastoi', 'Théo', 'Mathias Samson', 'Julien Nicolle'],
